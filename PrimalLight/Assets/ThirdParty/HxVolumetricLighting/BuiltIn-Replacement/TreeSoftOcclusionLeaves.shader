Shader "HxVolumetric/Nature/Tree Soft Occlusion Leaves(Not Recommended)" {
	Properties{
...
#include "Assets/ThirdParty/HxVolumetricLighting/BuiltIn-Replacement/HxVolumetricCore.cginc"
#pragma multi_compile __ VTRANSPARENCY_ON
	...
	return VolumetricTransparencyBase(c, input.projPos);
#else
	return c;
#endif
