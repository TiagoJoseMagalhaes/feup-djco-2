...
public class HxVolumetricShadersUsed : ScriptableObject
{
    ...
    public static void SetVolumetricValues(bool full,bool lowRes, bool heightFog, bool heightFogOff, bool noise, bool noiseOff, bool transparency, bool transparencyOff, bool densityParticles, bool point, bool spot, bool directional, bool singlePass,bool projector)
    {
        ...
        if (!BuildPipeline.isBuildingPlayer)
        {
            if (instance == null)
            {
                instance = AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders.asset", typeof(HxVolumetricShadersUsed)) as HxVolumetricShadersUsed;

                if (instance == null)
                {
                    instance = ScriptableObject.CreateInstance<HxVolumetricShadersUsed>();
                    AssetDatabase.CreateAsset(instance, "Assets/ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders.asset");
                    AssetDatabase.SaveAssets();
                    // instance = AssetDatabase.LoadAssetAtPath("Assets/ThirdParty/HxVolumetricLighting/HxUsedShaders.asset", typeof(HxVolumetricShadersUsed)) as GameObject;
                }
            }
    ...
    void RebuildQualityFile()
    {
        ...
        //Debug.Log("Path = " + Application.dataPath + "/ThirdParty/HxVolumetricLighting/Resources/Shaders/hxQualitySettings.cginc");
        File.WriteAllText(Application.dataPath + "/ThirdParty/HxVolumetricLighting/Resources/Shaders/hxQualitySettings.cginc", ShaderCode);
    ...
    void BuildShaders()
    {
        ...
        AssetDatabase.CreateAsset(collection, "Assets/ThirdParty/HxVolumetricLighting/Resources/HxUsedShaderVariantCollection.shadervariants");
