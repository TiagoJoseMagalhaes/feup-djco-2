...
public class HxVolumetricCameraEditor : Editor  
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        {
            EditorGUILayout.LabelField(new GUIContent("Quality", "To change quality, modify the density quality in ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders and hit build shaders"), new GUIContent("" + HxVolumetricCamera.DensityBufferDepth, "To change quality, modify the density quality in ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders and hit build shaders"));
        ...
        if (EditorGUILayout.BeginFadeGroup(m_ShowTransparency.faded))
        {
            ...
            EditorGUILayout.LabelField(new GUIContent("Quality", "To change quality, modify the transparency quality in ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders and hit build shaders"), new GUIContent("" + HxVolumetricCamera.TransparencyBufferDepth, "To change quality, modify the transparency quality in ThirdParty/HxVolumetricLighting/Resources/HxUsedShaders and hit build shaders"));
